...
# os.chdir('C:/Users/Admin/PycharmProjects/facenet/facenet_pytorch/examples')
# try:
#     import facenet_pytorch.examples.tmptest
# except:
#     import tmptest
# os.chdir('..')
...
dataset = datasets.ImageFolder('C:/Users/Admin/PycharmProjects/facenet/facenet_pytorch/data/test_images', transform=trans)
...
img = Image.open('C:/Users/Admin/PycharmProjects/facenet/facenet_pytorch/data/multiface.jpg')
...
mtcnn = MTCNN(keep_all=True)
img = [
    Image.open('C:/Users/Admin/PycharmProjects/facenet/facenet_pytorch/data/multiface.jpg'),
    Image.open('C:/Users/Admin/PycharmProjects/facenet/facenet_pytorch/data/multiface.jpg')
]
